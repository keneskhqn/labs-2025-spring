...
bg = pygame.image.load("lab7/music/pitbul12.png")

songs = [os.path.join("lab7/music/", song) for song in 
         ['GiveMeEverything.mp3', 'HeyBaby.mp3', 'OnTheFloor.mp3', "IKnowYouWantMe.mp3"]]
